/******************************************************************************
Module:  SchedLab.cpp
Notices: Copyright (c) 2020 Wenkai Yu
******************************************************************************/
...
BOOL Dlg_OnInitDialog(HWND hWnd, HWND hWndFocus, LPARAM lParam) {
    ...
    if (SetPriorityClass(GetCurrentProcess(), BELOW_NORMAL_PRIORITY_CLASS)) {
        // this system support the BELOW_NORMAL_PRIORITY_CLASS class
        // restore our original priority class
        SetPriorityClass(GetCurrentProcess(), dwpc);
        // add the above normal
    ...
    // LimitText
    Edit_LimitText(GetDlgItem(hWnd, IDC_Sleep), 4); // Maximum of 9999
    return TRUE;
}
